...
// import { Org, User, Permission, ACCESS } from "./model";
...
export class UisControllerContract extends Contract {
  ...
  //   return ctx.stub.createCompositeKey(KEYS.ORG_KEY_PREFIX, [orgId]);
  // }
  // GetUserKey(ctx: Context, userId: string): string {
  //   return ctx.stub.createCompositeKey(KEYS.USER_KEY_PREFIX, [userId]);
  // }
  // @Transaction()
